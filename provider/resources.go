...
import (
	...
	provider "github.com/IBM-Cloud/terraform-provider-ibm/ibm/provider" // Import the upstream provider
...
const (
	...
	mainPkg = "ibmcloud"
	// modules:
	mainMod = "index" // the ibmcloud module
)

//go:embed cmd/pulumi-resource-ibmcloud/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"ibmcloud", "ibm", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://github.com/mapt-oss/pulumi-ibmcloud",
		...
		Config:       map[string]*tfbridge.SchemaInfo{
			// Configuration will be inherited from the IBM Cloud Terraform provider
		},
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/mapt-oss/pulumi-ibmcloud/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("ibm_", mainMod,
